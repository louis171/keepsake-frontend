...
import EditMemoryModal from "../Modal/EditMemoryModal";
...
const Profile = () => {
  ...
  const [filteredMemoryPages, setFilteredMemoryPages] = useState([]);
    ...
    <Container>
      ...
      <Row>
        <Col
          ...
          lg={4}
        >
          <Button className="d-grid" style={{ width: "100%" }}>
            Add Keepsake
          </Button>
        </Col>
        <Col
        ...
        >
          <DropdownButton
            className="d-grid"
            style={{ width: "100%" }}
            onClick={userSortHandler}
            id="0"
            title={userSort}
          >
            <Dropdown.Item value="Date Desc" id="1" as="button">
              Date Desc
            </Dropdown.Item>
            <Dropdown.Item value="Date Asc" id="2" as="button">
              Date Asc
            </Dropdown.Item>
            <Dropdown.Item value="A - Z" id="3" as="button">
              A - Z
            </Dropdown.Item>
            <Dropdown.Item value="Z - A" id="4" as="button">
              Z - A
            </Dropdown.Item>
          </DropdownButton>
        </Col>
